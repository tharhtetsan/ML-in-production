...
eval $(aws ecr get-login --registry-ids <aws_account_id>. --region <region> --no-include-email)
...
```bash
REMOTE_URI="517074519053.dkr.ecr.ap-southeast-2.amazonaws.com/duration-model"
REMOTE_TAG="v1"
...
### References
https://github.com/DataTalksClub/mlops-zoomcamp/blob/main/04-deployment/streaming/README.md
...
https://stackoverflow.com/questions/67114132/aws-ecr-get-login-password-invalid-choice-on-ubuntu-18-04
